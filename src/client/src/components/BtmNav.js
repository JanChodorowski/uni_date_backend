        ...
        {isSmallView ?
            ...
            <Paper className={classes.root} square>
                ...
                >
                    ...
                    <Grid item>
                        <IconButton size="small" onClick={handleChangeOnSmallView("filter")}>
                            <FilterListIcon></FilterListIcon>
                        </IconButton>
                    </Grid>
                    <Grid item>
                        <IconButton size="small" onClick={handleChangeOnSmallView("profile")}>
                            <AccountCircleIcon></AccountCircleIcon>
                        </IconButton>
                    </Grid>
                    <Grid item>
                        <IconButton size="small" onClick={handleChangeOnSmallView("settings")}>
